...
import { Search, TrendingUp, BarChart3, Crown, Zap, Activity, Brain, ArrowRight, Navigation } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          { href: "/trading/auto", icon: Navigation, label: "KoshPilot", color: "text-amber-400" },
